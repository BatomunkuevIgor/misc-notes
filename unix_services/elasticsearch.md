...
[Изменение состояния одиночного экземпляра ElasticSearch] (#es_Health_set_to Green)</br>
...
### Изменение состояния одиночного экземпляра ElasticSearch <a name=es_Health_set_to Green></a></br>
